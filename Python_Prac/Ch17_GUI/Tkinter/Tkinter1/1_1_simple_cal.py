...
def cal(op):
    ...
    if op in ["+","-","*","/"]:
        ...
        e.insert(0,f"{f_num} {operation} {second_num}")
        e2.delete(0,END)
        e2.insert(0,result)
...
btn_add=Button(root,text="+",padx=39,pady=20,command=lambda:cal("+"))
btn_sub=Button(root,text="-",padx=40,pady=20,command=lambda:cal("-"))
btn_mul=Button(root,text="*",padx=40,pady=20,command=lambda:cal("*"))
btn_div=Button(root,text="/",padx=40,pady=20,command=lambda:cal("/"))
btn_equal=Button(root,text="=",padx=86,pady=20,command=lambda:cal("="))
